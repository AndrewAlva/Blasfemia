...
<!--[if gt IE 8]><!--> <html lang="es" class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="fullwrapper" class="hidden">
            ...
            <div id="share-btn">
                <a href="https://www.facebook.com/sharer/sharer.php?app_id=1593759844211289&sdk=joey&u=http%3A%2F%2Fmandelbrot.mx%2Fblasfemia&display=popup&ref=plugin" target="_blank"></a>
            </div>

            <div id="blasfemiamenu-wrapper">
                <a class="twitter-timeline" href="https://twitter.com/hashtag/ATuLadoHubiera" data-widget-id="597135752145670144"><span class="pincheinter">#PINCHE INTERNET!</span> <br> Recarga la pagina</a>
